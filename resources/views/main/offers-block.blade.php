<section class="offers-block">
		...
		<div class="trip-block">
			<div class="trip-block_title">
				...
				<a class="trip-block_title_link" href="#">Показать все ({{$inRecommendedCount}}) &nbsp;<i class="fas fa-long-arrow-alt-right"></i></a>
			</div>
		...
		<div class="trip-block">
			<div class="trip-block_title">
				...
				<div class="trip-block_title_link">
					<a href="#">Показать все ({{$inHotCount}}) &nbsp;<i class="fas fa-long-arrow-alt-right"></i></a>
				</div>
			</div>
			<div class="trip-block_cards">
