	...
	<div class="swiper-container">
	    <div class="swiper-wrapper">
	        ...
	        <div class="swiper-slide">
	        		<img class="swiper-slide_image" src="img/east.jpg" alt="">
	        ...
	        <div class="swiper-slide">	
	        		<img class="swiper-slide_image" src="img/north.jpg" alt="">
	        		<div class="swiper-slide_describe">
	        ...
	        <div class="swiper-slide">
	        		<img class="swiper-slide_image" src="img/south.jpg" alt="">
	        		<div class="swiper-slide_describe">
	        ...
	        <div class="swiper-slide">
	        		<img class="swiper-slide_image" src="img/west.jpg" alt="">
	        		<div class="swiper-slide_describe">
	        			<p class="swiper-slide_describe_title">Тайны Wall Street</p>
	        			<p class="swiper-slide_describe_slogan">Всё бабло запада</p>
	        			<div class="single-btn mod_160 mod_transparent">Перейти к туру</div>
	        		</div>
	        </div>
